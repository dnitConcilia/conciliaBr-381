...
urlpatterns = [
	...
	url(r'^banco-imoveis/$', views.imoveis_banco, name='imoveis_banco'),
	url(r'^localizacao-imoveis/$', views.imoveis_localizacao, name='imoveis_localizacao'),
	url(r'^caracteristicas-imoveis/$', views.imoveis_caracteristica, name='imoveis_caracteristica'),
	url(r'^destinacao-imoveis/$', views.imoveis_destinacao, name='imoveis_destinacao'),
	url(r'^acesso-imoveis/$', views.imoveis_acesso, name='imoveis_acesso'),
