...
# Página Banco de Imóveis
class ImoveisBancoView(TemplateView):
    template_name = 'imoveis_banco.html'

# Página Localizações de Imóveis
class ImoveisLocalizacaoView(TemplateView):
    template_name = 'imoveis_localizacao.html'

# Página Características de Imóveis
class ImoveisCaracteristicasView(TemplateView):
    template_name = 'imoveis_caracteristica.html'

# Página Destinação de Imóveis
class ImoveisDestinacaoView(TemplateView):
    template_name = 'imoveis_destinacao.html'

# Página Acesso de Imóveis
class ImoveisAcessoView(TemplateView):
    template_name = 'imoveis_acesso.html'
...
imoveis_banco = ImoveisBancoView.as_view()
imoveis_localizacao = ImoveisLocalizacaoView.as_view()
imoveis_caracteristica = ImoveisCaracteristicasView.as_view()
imoveis_destinacao = ImoveisDestinacaoView.as_view()
imoveis_acesso = ImoveisAcessoView.as_view()
